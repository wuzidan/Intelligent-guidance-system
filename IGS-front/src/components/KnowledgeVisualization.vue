        ...
        <div class="card">
          ...
          <div class="progress-item">
            ...
            <div class="progress-container">
              <div class="progress" :style="{ width: overallProgress + '%' }" :class="getProgressColorClass(overallProgress)"></div>
            </div>
          </div>
          <div class="progress-item">
            <div class="progress-label">
            ...
            <div class="progress-container">
              <div class="progress" :style="{ width: (completedCourses/totalCourses)*100 + '%' }" :class="getProgressColorClass((completedCourses/totalCourses)*100)"></div>
            </div>
          </div>
          <div class="progress-item">
            <div class="progress-label">
            ...
            <div class="progress-container">
              <div class="progress" :style="{ width: avgScore + '%' }" :class="getProgressColorClass(avgScore)"></div>
            </div>
          </div>
        </div>
          ...
          <div class="skill-card" v-for="skill in skills" :key="skill.name">
            ...
            <div class="skill-info">
              ...
              <div class="skill-progress-container">
                <div class="skill-progress" :style="{ width: skill.level + '%' }" :class="getSkillColorClass(skill.level)"></div>
              </div>
              <p class="skill-level">{{ getSkillLevelText(skill.level) }}</p>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      // 初始化学习进度柱状图
      const progressCtx = document.getElementById('learningHoursChart').getContext('2d');
